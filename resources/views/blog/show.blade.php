        ...
        <div class="max-w-4xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-3">
                    ...
                    @if($article->article_steps && count($article->article_steps) > 0)
                        <!-- Step-based Content -->
                        <div class="space-y-8">
                            @foreach($article->article_steps as $step)
                                <div class="step-container bg-dark-100/50 rounded-xl p-8 border border-gray-800 relative">
                                    ...
                                    <div class="flex items-start mb-6">
                                        ...
                                        <div class="flex-1">
                                            <h2 class="text-2xl font-semibold text-white mb-4">{{ $step['title'] }}</h2>
                                        </div>
                                    </div>
                                            ...
                                            <div class="code-block">
                                                <div class="bg-dark-200 rounded-t-lg px-4 py-2 flex justify-between items-center border-b border-gray-700">
                                                    <div class="flex items-center">
                                                        ...
                                                        <span class="text-sm font-semibold text-gray-300">{{ strtoupper($step['code_language']) }}</span>
                                                    </div>
                                                ...
                                                <pre class="bg-dark-300 rounded-b-lg p-4 overflow-x-auto border border-gray-700"><code class="language-{{ $step['code_language'] }} text-sm">{{ $step['code'] }}</code></pre>
                                            </div>
                                        @endif
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-24 space-y-6">
                        ...
                        <div class="bg-dark-100 rounded-xl p-6 border border-gray-800">
                            ...
                            <div class="space-y-3">
                                @foreach($article->article_steps as $index => $step)
                            ...
                            <p class="text-xs text-gray-400 mt-2">
                                <span class="completed-steps">0</span> dari {{ count($article->article_steps) }} langkah selesai
                            </p>
                        </div>
                        @endif
